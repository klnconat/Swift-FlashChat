...
class ChatViewController: UIViewController {
    ...
    func loadMessages() {
        db.collection(K.FStore.collectionName).order(by: K.FStore.dateField, descending: true).addSnapshotListener { querySnapShot, error in
            if let e = error {
                print("Failed to receive daata from database. \(e)")
            } else {
